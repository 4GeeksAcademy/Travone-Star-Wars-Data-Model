...
def get_user_favorites():
    ...
    for fav in favorites:
        if fav.people_id:
            ...
            result.append({"type": "people", "id": fav.people_id, "name": person.name if person else None})
        if fav.planet_id:
            planet = Planet.query.get(fav.planet_id)
            result.append({"type": "planet", "id": fav.planet_id, "name": planet.name if planet else None})
